package com.yeguohao.music.main.components.playqueue.fragments;
...
import com.yeguohao.music.main.components.playqueue.activities.AppendQueueActivity;
...
public class PlaySongQueue extends DialogFragment {
    ...
    @OnClick(R.id.add_queue)
    void addQueue() {
        startActivity(new Intent(getActivity(), AppendQueueActivity.class));
    }
